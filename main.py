...
def check_stock_symbol(flag: object = False, companies_file: object = 'companylist.csv') -> object:
...
def retrieving_tweets_polarity(symbol: object) -> object:
...
def recommending(df: object, forecast_out: object, global_polarity: object) -> object:
